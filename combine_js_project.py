...
EXCLUDE_DIRS = {'__pycache__', 'venv', '.git', 'logs', 'data', 'artifacts', 'node_modules', 'build', 'dist'}
EXCLUDE_FILES = {'package-lock.json', 'yarn.lock', 'README.md'}

# Define the output file
OUTPUT_FILE = os.path.join(PROJECT_ROOT, 'combined_project.tsx')

# Supported file extensions
SUPPORTED_EXTENSIONS = {'.tsx', '.ts', '.js', '.json'}
